  ...
  return (
    <nav
      className={`fixed  top-4 left-1/2 -translate-x-1/2 z-50
                 inline-flex items-center h-16 
                rounded-lg bg-card text-foreground border px-2 
                ${className}`}
    >
      {items.map(({ id, icon, label, onClick }, index) => (
        <a
          ...
          className={`relative z-20 flex h-full cursor-pointer 
      ...
      >
        <div
          className="absolute left-[-30%] top-[5px] w-[160%] h-14 
